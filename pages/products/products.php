...
<body>
                        ...
                        <div class="col-auto ms-auto d-print-none">
                            <div class="btn-list">
                                <a href="#" class="btn btn-primary btn-5 d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modal-report">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-bag-plus">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-sm btn-purple btn-edit-invoice"
                                                    ...
                                                    data-product-desc="<?= htmlspecialchars($row['product_desc']); ?>"
                                                ...
                                                <a href="product_delete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger btn-delete-invoice">
    ...
    <div class="modal modal-blur fade" id="modal-edit-invoice" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="update_product.php" method="POST" class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Product Description</label>
                        <input type="text" class="form-control" name="product_desc" id="product_desc" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Price</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label">Qty</label>
                        <input type="number" class="form-control" name="qty" id="qty-date" required>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        document.querySelectorAll('.btn-edit-invoice').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('product_desc').value = productDesc;
                document.getElementById('product_price').value = productPrice;
                document.getElementById('qty-date').value = qty;
            });
        });
