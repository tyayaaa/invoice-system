...
<body>
                ...
                <div class="container-xl">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title mb-0">List of customers</h3>
                        </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="customer_delete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger btn-delete-invoice" title="Edit Invoice">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="phone" pattern="[0-9]+" title="Masukkan hanya angka" required>
                        </div>
                    </div>
    ...
    <div class="modal modal-blur fade" id="modal-edit-invoice" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="update_customers.php" method="POST" class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Phone</label>
                        <input type="text" class="form-control" name="phone" id="phone" pattern="[0-9]+" title="Masukkan hanya angka" required>
                    </div>
                </div>
                <div class="modal-footer">
