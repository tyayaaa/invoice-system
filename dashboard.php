...
<head>
    ...
    <title>Dashboard Labpresso</title>
        ...
        <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <div class="navbar-brand navbar-brand-autodark">
                    <a href="./dashboard.php" aria-label="Tabler"><svg xmlns="http://www.w3.org/2000/svg" width="110" height="32" viewBox="0 0 232 68" class="navbar-brand-image">
                ...
                <div class="collapse navbar-collapse" id="sidebar-menu">
                    ...
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pages/invoices/invoices.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pages/customers/customers.php">
                                ...
                                <div class="card-body">
                                    <div class="row gy-3">
                                        <div class="col-12 col-sm d-flex flex-column">
                                            <h3 class="h2">Welcome back, <?= isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : '' ?> </h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        <div class="h1 mb-0 me-2"><?= number_format($total_customers) ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        <div class="h1 mb-0 me-2"><?= number_format($total_products) ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                $query = "SELECT SUM(subtotal) as total_sales FROM invoices";
                                                $result = $mysqli->query($query);
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span class="bg-warning text-white avatar"><!-- Download SVG icon from http://tabler.io/icons/icon/shopping-cart -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1">
                                                ...
                                                $query = "SELECT COUNT(*) as total_orders FROM invoices";
                                                $result = $mysqli->query($query);
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span class="bg-green text-white avatar"><!-- Download SVG icon from http://tabler.io/icons/icon/brand-x -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-bell-dollar">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                ...
                                                $query = "SELECT SUM(subtotal) as total_income FROM invoices WHERE status = 'Transfer'";
                                                $result = $mysqli->query($query);
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                // Perhatikan alias di query harus sama dengan yang dipakai di PHP
                                                $query = "SELECT SUM(subtotal) AS total_unpaid FROM invoices WHERE status = 'Kasbon'";
                                                $result = $mysqli->query($query);
